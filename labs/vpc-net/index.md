...
![](index/HsG8XCSGDBfsuKk3IMJVgQscsg2E=.png)

The **mynetwork** network, its firewall rules, and two VM instances (**mynet-eu-vm** and **mynet-us-vm**) have already been created for you in the previous lab.
...
1. In the Cloud Console, on the **Navigation menu** (![](index/tkgw1TDgj4Q+YKQUW4jUFd0O5OEKlUMBRYbhlCrF0WY=.png)), click **VPC network** > **VPC networks**. Notice the **default** and **mynetwork** networks with their subnets.
...
1. In the Cloud Console, click **Activate Cloud Shell** (![](index/8sidHquE=.png)).
...
5. Run the following command to create the **privatesubnet-eu** subnet:
```bash
...
8. In the Cloud Console, on the **Navigation menu** (![](index/tkgw1TDgj4Q+YKQUW4jUFd0O5OEKlUMBRYbhlCrF0WY=%202.png)), click **VPC network** > **VPC networks**. Verify that the same networks and subnets are listed in the Cloud Console.

## Create the firewall rules for managementnet
Create firewall rules to allow **SSH**, **ICMP**, and **RDP** ingress traffic to VM instances on the **managementnet** network.
1. In the Cloud Console, on the **Navigation menu** (![](index/tkgw1TDgj4Q+YKQUW4jUFd0O5OEKlUMBRYbhlCrF0WY=%203.png)), click **VPC network** > **Firewall**.
...
1. Return to **Cloud Shell**. If necessary, click **Activate Cloud Shell** (![](index/8sidHquE=%202.png)).
...
4. In the Cloud Console, on the **Navigation menu** (![](index/tkgw1TDgj4Q+YKQUW4jUFd0O5OEKlUMBRYbhlCrF0WY=%204.png)), click **VPC network** > **Firewall**. Verify that the same firewall rules are listed in the Cloud Console.
...
1. In the Cloud Console, on the **Navigation menu** (![](index/tkgw1TDgj4Q+YKQUW4jUFd0O5OEKlUMBRYbhlCrF0WY=%205.png)), click **Compute Engine** > **VM instances**.
...
1. Return to **Cloud Shell**. If necessary, click **Activate Cloud Shell** (![](index/8sidHquE=%203.png)).
...
4. In the Cloud Console, on the **Navigation menu** (![](index/tkgw1TDgj4Q+YKQUW4jUFd0O5OEKlUMBRYbhlCrF0WY=%206.png)), click **Compute Engine** > **VM instances**. Verify that the VM instances are listed in the Cloud Console.
